...
func (dlp *downloadTesterPeer) RequestHeadersByHash(origin common.Hash, amount, skip int, reverse bool) error {
...
// origin; associated with a particular peer in the download tester. The returned
// function can be used to retrieve batches of headers from the particular peer.
func (dlp *downloadTesterPeer) RequestHeadersByNumber(origin uint64, amount, skip int, reverse bool) error {
...
func (ftp *floodingTestPeer) RequestHeadersByHash(hash common.Hash, count, skip int, reverse bool) error {
